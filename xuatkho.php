...
<head>
    ...
    <title>Quản lý Xuất Kho - Thịnh Tiến</title>
    <style>
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="main-content">
            <main>
                <h2>Giao diện Quản lý Xuất Kho</h2>
                <br>
                <button class="btn-add">+ Tạo phiếu xuất mới</button>
