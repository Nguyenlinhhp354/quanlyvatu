...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['action'])) {
    ...
    if (empty($id_new) || empty($ten)) {
        ...
        if ($action == 'add') {
            // Kiểm tra trùng ID hoặc Tên khi thêm mới
        ...
        elseif ($action == 'edit') {
            ...
            // Kiểm tra trùng ID/Tên với dự án khác (trừ chính nó)
...
<body>
        ...
        <div class="main-content">
            <main>
                <div style="margin-bottom: 20px;">
                    <a href="QLquytrinhdieuphoi.php" style="font-weight:bold; color:blue; text-decoration:none;">Quản lý quy trình</a> > Quản lý dự án
                </div>
                ...
                <div style="display: flex; justify-content: space-between; margin-bottom: 20px;">
                    <form method="GET" style="display: flex; gap: 5px;" autocomplete="off">
                        <input type="text" name="search" placeholder="Tìm id hoặc tên..." 
                               ...
                               autocomplete="off">
                        <button type="submit" class="btn-action" style="background: black; color: white; border: none; padding: 5px 10px;">Tìm kiếm</button>
                    </form>
                    <button class="btn-action" style="background:#007bff; color:white; border:none; padding:10px 20px; border-radius:5px;" onclick="openModal('add')">Thêm dự án</button>
                </div>
        ...
        <div class="msg-box">
            ...
            <form method="POST">
                ...
                <div style="text-align: right; margin-top: 15px;">
                    ...
                    <button type="submit" class="btn-msg" style="background:#007bff; color:white; border:none;">Xác nhận</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <script>
        ...
        function openModal(mode, id='', ten='', dia='', tt='Đang thi công') {
            document.getElementById('m_title').innerText = (mode == 'add') ? 'Thêm dự án mới' : 'Sửa dự án';
        ...
        // Hiện thông báo thành công/lỗi hoặc xác nhận xóa
