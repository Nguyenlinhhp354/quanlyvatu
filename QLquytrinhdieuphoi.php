...
$quytrinh = [
    ["tieude" => "Quản lí phiếu yêu cầu vật tư", "lienket" => "quanlyphieuyeucau.php"],
    ["tieude" => "Phê duyệt yêu cầu vật tư", "lienket" => "pheduyetyeucau.php"],
    ["tieude" => "Quản lí phiếu đề nghị mua hàng", "lienket" => "quanlyphieudenghi.php"],
    ["tieude" => "Theo dõi lịch trình cung ứng vật tư", "lienket" => "theodoicungung.php"],
    ["tieude" => "Quản lí phiếu hoàn trả vật tư", "lienket" => "quanlyphieuhoantra.php"],
    ["tieude" => "Quản lí dự án", "lienket" => "quanlyduan.php"]
];
?>
<!DOCTYPE html>
<html lang="vi">
